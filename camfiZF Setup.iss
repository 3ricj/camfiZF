...
; Generated by 3ric Johanson on 9/9/2020 (UTC)
;
[Setup]
AppID={{74e7a626-e0e9-4115-83bf-7f333729fbfa}
AppName=ASCOM camfiZF Focuser Driver
AppVerName=ASCOM camfiZF Focuser Driver 1.0
AppVersion=1.0
AppPublisher=3ric Johanson <ericjohanson@gmail.com>
AppPublisherURL=mailto:ericjohanson@gmail.com
...
OutputDir="."
OutputBaseFilename="camfiZF Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\camfiZF"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\camfiZF"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\3ricj\source\repos\camfiZF\bin\Release\ASCOM.camfiZF.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\3ricj\source\repos\camfiZF\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.camfiZF.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.camfiZF.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.camfiZF.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.camfiZF.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.camfiZF.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
